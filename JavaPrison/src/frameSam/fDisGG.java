 ...
 * @author Nehal Kalnad
 */
public class fDisGG extends javax.swing.JFrame {

    /**
     * Creates new form fDisGG
     */
    public fDisGG() {
        initComponents();
        outPres.setText(Login.guard.displayGuard());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fDisGG.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
